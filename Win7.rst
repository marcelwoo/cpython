============
Python 3.9.5 fork for Windows 7 support
============
...
And in this folder we can see installer python-3.9.5-amd64.exe, install it as usual.

If you need debugging symbols and/or debug binaries, you need to use python-3.9.5-amd64-full.exe
